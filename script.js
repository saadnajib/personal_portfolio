...
(() => {
  ...
  function draw() {
    ...
    projected.forEach((p, i) => {
      const depth = (p.z + 1) / 2;
      ctx.fillStyle = `rgba(88,166,255,${.17 + depth * .75})`;
